...
import { Mic, MessageSquare, Volume2, Video, UserPlus, Phone } from 'lucide-react';
...
const CallScreen: React.FC<CallScreenProps> = ({ customerName = 'Customer', orderId }) => {
  ...
  const seed = customerName.replace(/\s+/g, '');
  ...
  return (
    <div className="h-screen w-full relative overflow-hidden bg-[#1c2c3e]">
      ...
      <div className="relative z-10 h-full flex flex-col items-center">
        ...
        <div className="flex flex-col items-center gap-6 mb-8 animate-in fade-in zoom-in duration-700">
          <div className="relative">
            ...
            <div className="w-32 h-32 rounded-full border-[3px] border-white/20 shadow-2xl overflow-hidden bg-gray-600">
              <img
                src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${seed}`}
                alt={customerName}
